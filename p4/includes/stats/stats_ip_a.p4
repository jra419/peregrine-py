control c_stats_ip_a(inout header_t hdr, inout ingress_metadata_a_t ig_md) {
	...
	action lshift_res_prod_21() {
		ig_md.stats_ip.res_prod = (bit<64>)(ig_md.stats_ip.res_0 << 21);
	}

	action lshift_res_prod_22() {
		ig_md.stats_ip.res_prod = (bit<64>)(ig_md.stats_ip.res_0 << 22);
	}

	action lshift_res_prod_23() {
		ig_md.stats_ip.res_prod = (bit<64>)(ig_md.stats_ip.res_0 << 23);
	}

	action lshift_res_prod_24() {
		ig_md.stats_ip.res_prod = (bit<64>)(ig_md.stats_ip.res_0 << 24);
	}

	action lshift_res_prod_25() {
		ig_md.stats_ip.res_prod = (bit<64>)(ig_md.stats_ip.res_0 << 25);
	}

	action lshift_res_prod_26() {
		ig_md.stats_ip.res_prod = (bit<64>)(ig_md.stats_ip.res_0 << 26);
	}

	action lshift_res_prod_27() {
		ig_md.stats_ip.res_prod = (bit<64>)(ig_md.stats_ip.res_0 << 27);
	}

	action lshift_res_prod_28() {
		ig_md.stats_ip.res_prod = (bit<64>)(ig_md.stats_ip.res_0 << 28);
	}

	action lshift_res_prod_29() {
		ig_md.stats_ip.res_prod = (bit<64>)(ig_md.stats_ip.res_0 << 29);
	}
	...
	apply {
		...
		// Sum of residual products calculation.
		res_prod.apply();
