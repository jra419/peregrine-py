...
from kitsune_tables import IpPktMean, IpCov, IpStdDev1, IpPcc, FiveTPktMean, FiveTCov, FiveTStdDev1, FiveTPcc
...
def configure_switch(program, topology):
    ...
    ip_std_dev_1.add_entry(15, 2, 0b11111110, 1)
    ip_std_dev_1.add_entry(14, 4, 0b11111100, 2)
    ip_std_dev_1.add_entry(13, 8, 0b11111000, 3)
    ip_std_dev_1.add_entry(12, 16, 0b11110000, 4)
    ip_std_dev_1.add_entry(11, 32, 0b11100000, 5)
    ip_std_dev_1.add_entry(10, 64, 0b11000000, 6)
    ip_std_dev_1.add_entry(9, 128, 0b10000000, 7)
    ip_std_dev_1.add_entry(8, 256, 0b1111111100000000, 8)
    ip_std_dev_1.add_entry(7, 512, 0b1111111000000000, 9)
    ip_std_dev_1.add_entry(6, 1024, 0b1111110000000000, 10)
    ip_std_dev_1.add_entry(5, 2048, 0b1111100000000000, 11)
    ip_std_dev_1.add_entry(4, 4096, 0b1111000000000000, 12)
    ip_std_dev_1.add_entry(3, 8192, 0b1110000000000000, 13)
    ip_std_dev_1.add_entry(2, 16384, 0b1100000000000000, 14)
    ip_std_dev_1.add_entry(1, 32768, 0b1000000000000000, 15)
    ...
    five_t_std_dev_1.add_entry(15, 2, 0b11111110, 1)
    five_t_std_dev_1.add_entry(14, 4, 0b11111100, 2)
    five_t_std_dev_1.add_entry(13, 8, 0b11111000, 3)
    five_t_std_dev_1.add_entry(12, 16, 0b11110000, 4)
    five_t_std_dev_1.add_entry(11, 32, 0b11100000, 5)
    five_t_std_dev_1.add_entry(10, 64, 0b11000000, 6)
    five_t_std_dev_1.add_entry(9, 128, 0b10000000, 7)
    five_t_std_dev_1.add_entry(8, 256, 0b1111111100000000, 8)
    five_t_std_dev_1.add_entry(7, 512, 0b1111111000000000, 9)
    five_t_std_dev_1.add_entry(6, 1024, 0b1111110000000000, 10)
    five_t_std_dev_1.add_entry(5, 2048, 0b1111100000000000, 11)
    five_t_std_dev_1.add_entry(4, 4096, 0b1111000000000000, 12)
    five_t_std_dev_1.add_entry(3, 8192, 0b1110000000000000, 13)
    five_t_std_dev_1.add_entry(2, 16384, 0b1100000000000000, 14)
    five_t_std_dev_1.add_entry(1, 32768, 0b1000000000000000, 15)
