...
sqrt = MathUnit(shift=-1, invert=False, scale=-7,
                lookup=lookup_sqrt)
...
class StatsCalc:
    ...
    def process(self, phase):
        ...
        if phase == 'training' or self.phase_pkt_index % self.sampling_rate == 0:
            ...
            ip_std_dev_1 = sqrt.compute(ip_variance_1)
        ...
        if phase == 'training' or self.phase_pkt_index % self.sampling_rate == 0:
            ...
            five_t_std_dev_1 = sqrt.compute(five_t_variance_1)
    ...
    def stats_calc_2d(self, pkt_cnt_0, pkt_cnt_1, mean_0, mean_1, res_sum, variance_0,
        ...
        # Magnitude
        magnitude = sqrt.compute(sqr.compute(mean_0) + sqr.compute(mean_1))

        # Radius
        radius = sqrt.compute(sqr.compute(variance_0) + sqr.compute(variance_1))
