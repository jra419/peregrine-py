...
class Peregrine:
    def __init__(
            self, max_autoencoder_size=10, fm_grace_period=None, ad_grace_period=10000,
            learning_rate=0.1, hidden_ratio=0.75, lambdas=4, feature_map=None,
            ensemble_layer=None, output_layer=None, train_stats=None, attack='',
            train_skip=False, train_exact_ratio=0):

        # Initialize KitNET.
        self.AnomDetector = KitNET(
            80, max_autoencoder_size, fm_grace_period, ad_grace_period, learning_rate,
            hidden_ratio, feature_map, ensemble_layer, output_layer, attack, train_exact_ratio)
    ...
    def proc_next_packet(self, cur_stats):
        ...
        processed_stats = np.concatenate((
